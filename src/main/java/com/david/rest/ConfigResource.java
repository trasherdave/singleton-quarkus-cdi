...
/**
 * Este é um Controller REST que fornece uma API para consulta de endereços a
 * partir do CEP.
 *
 * <p>
 * O framework Quarkus recomenda que os atributos injetados tenham visibilidade
 * package, pois ele faz modificações no bytecode gerado.
 * </p>
 *
